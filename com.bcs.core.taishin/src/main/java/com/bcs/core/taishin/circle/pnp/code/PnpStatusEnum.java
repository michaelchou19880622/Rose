...
public enum PnpStatusEnum {
    ...
    BC_USER_IN_BLACK_LIST("BC_IN_BLACK_LIST", "該用戶於黑名單中"),
    BC_USER_IN_BLACK_LIST_PNP_PROCESS("BC_IN_BLACK_LIST_PNP_PROCESS", "該用戶於黑名單中，轉發PNP"),
    BC_USER_IN_BLACK_LIST_SMS_PROCESS("BC_IN_BLACK_LIST_SMS_PROCESS", "該用戶於黑名單中，轉發SMS"),

    BC_USER_BLOCKED("USER_BLOCK", "用戶已封鎖"),
    BC_USER_BLOCKED_PNP_PROCESS("USER_BLOCK_PNP_PROCESS", "用戶已封鎖，轉發PNP"),
    BC_USER_BLOCKED_SMS_PROCESS("USER_BLOCK_SMS_PROCESS", "用戶已封鎖，轉發SMS"),
    ...
    USER_IS_UNBIND_IGNORE_TO_SMS("USER_IS_UNBIND_IGNORE_TO_SMS", "用戶未綁定，轉發SMS"),
    USER_IS_UNBIND_IGNORE_TO_PNP("USER_IS_UNBIND_IGNORE_TO_PNP", "用戶未綁定，轉發PNP"),
    USER_IS_UNBIND_IGNORE("USER_IS_UNBIND_IGNORE", "用戶未綁定，禁止發送BC"),
    ...
    PNP_SENT_TO_LINE_FAIL_SMS_PROCESS("PNP_FAIL_SMS_PROCESS", "發送至LINE平台失敗(用戶關閉接收通知或LINE註冊電話號碼未匹配)，轉發SMS"),

    PNP_SENT_COMPLETE("PNP_COMPLETE", "發送成功"),

    PNP_USER_IN_BLACK_LIST_SMS_PROCESS("PNP_IN_BLACK_LIST_SMS_PROCESS", "該用戶於黑名單中，轉發SMS"),
