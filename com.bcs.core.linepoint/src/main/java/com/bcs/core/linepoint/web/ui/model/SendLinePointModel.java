...
public class SendLinePointModel extends AbstractBcsEntity{
	...
	private List<SendLinePointDetailModel> sendMsgDetails;
	...
	public List<SendLinePointDetailModel> getSendMsgDetails() {
		return sendMsgDetails;
	}

	public void setSendMsgDetails(List<SendLinePointDetailModel> sendMsgDetails) {
