...
$(function(){
	...
	$('.btn_add.search').click(function(){
		...
		$.ajax({
			type : 'GET',
			url : bcs.bcsContextPath + '/edit/getPNPMaintainAccountList?departmentName=' + departmentName + '&pccCode=' + pccCode + '&account=' 
			+ account + '&employeeId=' + employeeId + '&accountType=Normal'
	...
	var setExportButtonSource = function() {
		if(hasData) {
			...
			+ '&account=' + account + '&employeeId=' + employeeId + '&accountType=Normal';
