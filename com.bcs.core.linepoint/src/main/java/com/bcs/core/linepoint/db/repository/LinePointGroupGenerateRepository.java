...
@Repository
public class LinePointGroupGenerateRepository{

	/** Logger */
	private static Logger logger = Logger.getLogger(LinePointGroupGenerateRepository.class);
	...
	public List<String> findMIDBySendGroupDetailGroupId(Long groupId) throws Exception {
		List<LinePointSendGroupDetail> sendGroupDetails = sendGroupDetailRepository.findBySendGroupGroupId(groupId);
	...
	private Query buildFindQuery(List<LinePointSendGroupDetail> sendGroupDetails, String selectColumns) throws Exception {
	 ...
	 * @throws Exception 
	 */
	private Query buildFindQuery(List<LinePointSendGroupDetail> sendGroupDetails, String selectColumns, String mid) throws Exception {
		Validate.notEmpty(sendGroupDetails);
		Validate.notEmpty(selectColumns);
		
		List<LinePointSendGroupDetail> sendGroupSetting = new ArrayList<LinePointSendGroupDetail>();
		List<LinePointSendGroupDetail> uploadMidSetting = new ArrayList<LinePointSendGroupDetail>();
		
		// 分離 Upload Mid Detail Setting
		for(LinePointSendGroupDetail detail : sendGroupDetails){
	...
	private String generateMidFieldSettingFrom(List<LinePointSendGroupDetail> sendGroupDetails, int params){
		...
		if(sendGroupDetails != null && sendGroupDetails.size() > 0){
			...
			LinePointSendGroupDetail detail = sendGroupDetails.get(0);
	 ...
	 * @return
	 */
	private String generateUploadMidSettingFrom(List<LinePointSendGroupDetail> sendGroupDetails, int params){
	 ...
	 * @param sendGroupDetails
	 */
	private void checkSendGroupDetail(List<LinePointSendGroupDetail> sendGroupDetails) {
		for (LinePointSendGroupDetail sendGroupDetail : sendGroupDetails) {
