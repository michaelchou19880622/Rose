...
public interface MsgGenerator {
	...
	public abstract Message getMessageBot(String toContent, String toType) throws Exception;

	public abstract Message getMessageBot(String toContent, String toType, Map<String, String> replaceParam) throws Exception;
}
