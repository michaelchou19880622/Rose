...
public enum CONFIG_STR {
	...
	//三竹
//	PNP_FTP_SERVER_NAME_MITAKE("pnp.ftp.server.name.mitake"),
//	PNP_FTP_SERVER_PORT_MITAKE("pnp.ftp.server.port.mitake"),
//	PNP_FTP_USR_MITAKE("pnp.ftp.usr.mitake"),
//	PNP_FTP_PASS_MITAKE("pnp.ftp.pass.mitake"),
//	PNP_FTPDOWNLOAD_SAVEFILEPATH_MITAKE("pnp.ftpDownload.saveFilePath.mitake"),
//	PNP_FTPDOWNLOAD_PATH_MITAKE("pnp.ftpDownload.path.mitake"),
//	PNP_FTPUPLOAD_PATH_MITAKE("pnp.ftpUpload.path.mitake"),
//	
	...
	PNP_FTP_UPLOAD_SMS_PATH_MITAKE("pnp.ftp.upload.sms.path.mitake"),
	...
	//三竹
	//互動
//	PNP_FTP_SERVER_NAME_EVERY8D("pnp.ftp.server.name.every8d"),
//	PNP_FTP_SERVER_PORT_EVERY8D("pnp.ftp.server.port.every8d"),
//	PNP_FTP_USR_EVERY8D("pnp.ftp.usr.every8d"),
//	PNP_FTP_PASS_EVERY8D("pnp.ftp.pass.every8d"),
//	PNP_FTPDOWNLOAD_SAVEFILEPATH_EVERY8D("pnp.ftpDownload.saveFilePath.every8d"),
//	PNP_FTPDOWNLOAD_PATH_EVERY8D("pnp.ftpDownload.path.every8d"),
//	PNP_FTPUPLOAD_PATH_EVERY8D("pnp.ftpUpload.path.every8d"),
	...
	PNP_FTP_UPLOAD_SMS_PATH_EVERY8D("pnp.ftp.upload.sms.path.every8d"),
	...
	//互動
	//明宣
//	PNP_FTP_SERVER_NAME_MING("pnp.ftp.server.name.ming"),
//	PNP_FTP_SERVER_PORT_MING("pnp.ftp.server.port.ming"),
//	PNP_FTP_USR_MING("pnp.ftp.usr.ming"),
//	PNP_FTP_PASS_MING("pnp.ftp.pass.ming"),
//	PNP_FTPDOWNLOAD_SAVEFILEPATH_MING("pnp.ftpDownload.saveFilePath.ming"),
//	PNP_FTPDOWNLOAD_PATH_MING("pnp.ftpDownload.path.ming"),
//	PNP_FTPUPLOAD_PATH_MING("pnp.ftpUpload.path.ming"),
	...
	PNP_FTP_UPLOAD_SMS_PATH_MING("pnp.ftp.upload.sms.path.ming"),
	...
	PNP_FTP_UPLOAD_SMS_PATH_UNICA("pnp.ftp.upload.sms.path.unica"),
...
//	PNP_FTP_SERVER_NAME_UNICA(""),
//	PNP_FTP_SERVER_PORT_UNICA(""),
//	PNP_FTP_USR_UNICA(""),
//	PNP_FTP_PASS_UNICA(""),
//	PNP_FTPDOWNLOAD_SAVEFILEPATH_UNICA(""),
//	PNP_FTPDOWNLOAD_PATH_UNICA("pnp.ftpDownload.path.unica"),
//	PNP_FTPUPLOAD_PATH_UNICA("pnp.ftpUpload.path.unica"),
	//PNP白名單
