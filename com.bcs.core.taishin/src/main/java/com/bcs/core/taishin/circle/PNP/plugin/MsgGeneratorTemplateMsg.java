...
public class MsgGeneratorTemplateMsg extends MsgGeneratorAbstract {
	...
	@Override
	public Message getMessageBot(String toContent, String toType) throws Exception{
	...
	@Override
	public Message getMessageBot(String toContent, String toType, Map<String, String> replaceParam) throws Exception{
	...
	public Message getMessageBot(String toContent, String toType, List<CarouselColumn> carouselColumns, List<Action> actions) throws Exception{
	...
	public Message getMessageBot(String toContent, String toType, Map<String, String> replaceParam, List<CarouselColumn> carouselColumns, List<Action> actions) throws Exception{
