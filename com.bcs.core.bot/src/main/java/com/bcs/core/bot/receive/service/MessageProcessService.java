...
public class MessageProcessService {
	...
	public Message generateWaitingMessage(Integer type) {
		...
		String thumbnailInageUrl = CoreConfigReader.getString(CONFIG_STR.BaseUrlHTTPS) + "BCS/images/rose_emoticon/rose_grateful.png";
		...
		if(type == 2) {
			...
			thumbnailInageUrl = CoreConfigReader.getString(CONFIG_STR.BaseUrlHTTPS) + "BCS/images/rose_emoticon/rose_happy.png";
	...
	public Message generateNotInOfficeHourMessage() {
		...
		Message confirmMessage = new TemplateMessage(
				text, 
				new ButtonsTemplate(
						CoreConfigReader.getString(CONFIG_STR.BaseUrlHTTPS) + "BCS/images/rose_emoticon/rose_joyful.png", 
