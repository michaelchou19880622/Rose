package com.bcs.core.linepoint.api.msg.model;

import com.bcs.core.json.AbstractBcsEntity;

public class LinePointAction extends AbstractBcsEntity {
	...
	public LinePointAction(String actionId, String actionText, String actionContent, int actionX, int actionY, int actionWidth, int actionHeight){
	...
	public LinePointAction(String actionId, String actionType, String actionText, String actionContent, int actionX, int actionY, int actionWidth, int actionHeight){
