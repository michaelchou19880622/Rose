...
$(function(){
	$('.btn_add').click(function(){
 		window.location.replace(bcs.bcsContextPath + '/admin/productGroupCreatePage');
	});
	...
	var btn_deteleFunc = function(){
		...
		$.ajax({
			type : "DELETE",
			url : bcs.bcsContextPath + '/admin/deleteProductGroup?groupId=' + groupId
	...
	var loadDataFunc = function(){
		...
		$.ajax({
			type : "GET",
			url : bcs.bcsContextPath + '/admin/getProductGroupList'
		}).success(function(response){
			$('.dataTemplate').remove();
			console.info(response);
			...
			$.each(response, function(i, o){
				...
				productData.find('.groupName a').attr('href', bcs.bcsContextPath + '/admin/productGroupCreatePage?groupId=' + o.groupId + '&actionType=Edit');
