...
@Service
public class LinePointSendGroupUIService {
	/** Logger */
	private static Logger logger = Logger.getLogger(LinePointSendGroupUIService.class);
	...
	public LinePointSendGroup saveFromUI(LinePointSendGroup sendGroup, String adminUserAccount) throws BcsNoticeException{
		...
		List<LinePointSendGroupDetail> list = sendGroup.getSendGroupDetail();
		sendGroup.setSendGroupDetail(new ArrayList<LinePointSendGroupDetail>());
		...
		if(list != null){
			for(LinePointSendGroupDetail detail : list){
