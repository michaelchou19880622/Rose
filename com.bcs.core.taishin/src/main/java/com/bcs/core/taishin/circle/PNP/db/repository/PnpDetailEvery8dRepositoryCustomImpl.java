...
@Repository
public class PnpDetailEvery8dRepositoryCustomImpl implements PnpDetailEvery8dRepositoryCustom {

	@Autowired
	private JdbcTemplate jdbcTemplate;
	
	/** Logger */
	private static Logger logger = Logger.getLogger(PnpDetailEvery8dRepositoryCustomImpl.class);
